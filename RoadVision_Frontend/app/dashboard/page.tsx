...
import { CommandLink } from "@/components/dashboard/command-link"
import {
    fetchProjects,
    type Project
} from "@/lib/api"
                    ...
                    <div className="mb-8 flex items-center gap-5">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 via-indigo-800 to-indigo-600 dark:from-white dark:via-indigo-200 dark:to-indigo-400 bg-clip-text text-transparent">
                                ROADvision_Lagos: Infrastructure Sentinel
                            </h1>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                AI-Powered Guardian for Nigeria's Roads | Created by David Akpoviroro Oke (MrIridescent)
                            </p>
                        </div>
                    </div>
